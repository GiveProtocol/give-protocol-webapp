    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
          {checked ? (
            <span>
              {formatFiat(amount, selectedCurrency, { decimals: 2 })} +{" "}
              {formatFiat(fee, selectedCurrency, { decimals: 2 })} fees ={" "}
            ...
            <span>
              Add {formatFiat(fee, selectedCurrency, { decimals: 2 })} to ensure
              100% of your{" "}
              {formatFiat(amount, selectedCurrency, { decimals: 2 })} goes to
              the charity
            </span>
          )}
        </p>
