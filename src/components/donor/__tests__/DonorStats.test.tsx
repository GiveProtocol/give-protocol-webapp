...
describe('DonorStats', () => {
  ...
  it('displays total donated amount', () => {
    ...
    expect(screen.getAllByTestId('currency-display').length).toBeGreaterThanOrEqual(1);
  });
  ...
  it('displays zero values correctly', () => {
    render(<DonorStats totalDonated={0} impactGrowth={0} charitiesSupported={0} />);
  ...
  it('renders with large values', () => {
    render(<DonorStats totalDonated={100000} impactGrowth={50000} charitiesSupported={42} />);
