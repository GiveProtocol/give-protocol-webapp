...
export const Input: React.FC<InputProps> = ({
  ...
  const baseClasses =
    "block w-full shadow-sm transition-all duration-200 placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-gray-900 text-gray-900 dark:text-gray-100";
  ...
  const variantClasses = {
    ...
    enhanced: cn(
      ...
      error &&
        "border-red-300 dark:border-red-600 focus:border-red-500 focus:shadow-[0_0_0_3px_rgba(239,68,68,0.1)]",
    ),
  };
