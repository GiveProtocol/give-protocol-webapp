  ...
  return (
    <>
      <h1 className="text-4xl font-bold sm:text-6xl leading-tight tracking-tight">
        {idx > -1 ? (
          <>
            ...
            <span className="bg-gradient-to-r from-emerald-600 to-cyan-500 dark:from-emerald-400 dark:to-cyan-400 bg-clip-text text-transparent">
              {GRADIENT_KEYWORD}
            </span>
          </>
        ) : (
      ...
      <p className="mt-4 text-xl text-gray-600">
        {t(
          "home.subtitle",
          "Connecting resources to the causes that need them most",
        )}
      </p>
    </>
  );
