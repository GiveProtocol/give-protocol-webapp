...
import { ValidationStatus, RejectionReason, ActivityType } from '@/types/selfReportedHours';
import {
...
describe('validationRequestService', () => {
  ...
  describe('getValidationQueueCount', () => {
    ...
    it('should return 0 on error', async () => {
      setMockResult('validation_requests', { count: null, error: { message: 'DB Error' } });
  ...
  describe('processValidationResponse', () => {
    ...
    it('should throw when request not found', async () => {
      setMockResult('validation_requests', { data: null, error: { message: 'Not found' } });
  ...
  describe('batchRejectRequests', () => {
    ...
    it('should handle failures gracefully', async () => {
      setMockResult('validation_requests', { data: null, error: { message: 'Error' } });
