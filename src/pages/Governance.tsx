          ...
          <div className="bg-white p-8 rounded-lg shadow-md">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Successful proposals are implemented after meeting all
                  required thresholds.
                </p>
              </div>
            </div>
          ...
          <div className="bg-emerald-50 p-8 rounded-lg flex items-start">
            ...
            <div>
              ...
              <p className="text-emerald-700">
                All governance participants are required to review and
                understand the complete governance documentation before
                participating in proposals or voting. This ensures informed
                decision-making and maintains the integrity of our governance
                process.
              </p>
            </div>
          </div>
