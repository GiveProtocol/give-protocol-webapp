          ...
          {isConnected && address && (
            ...
            >
              ...
              >
                ...
                Create an account to link this wallet and access your donation
                history, CEF portfolio, and SBT credentials across sessions.
                <a
                  href="/about"
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  >
                    Charity digital asset wallets are configured after account
                    creation by an authorized admin using your
                    organization&apos;s dedicated wallet — kept separate from
                    any personal wallets.
                  </p>
                </div>
              </div>
            </div>
