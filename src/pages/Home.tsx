...
const Home: React.FC = () => {
  ...
  return (
    <main
      id="main-content"
      className="min-h-screen bg-gradient-to-br from-slate-900 via-emerald-950 to-slate-900 text-gray-100 overflow-hidden"
    >
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <ImpactFundCard
            icon={
              <Globe className="w-24 h-24 text-white/80" aria-hidden="true" />
            }
          ...
          <ImpactFundCard
            icon={
              <Users className="w-24 h-24 text-white/80" aria-hidden="true" />
            }
