    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-emerald-950 to-slate-900 text-gray-100 overflow-hidden">
      ...
      <section id="features" className="relative z-10 container mx-auto px-6 py-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4">Your Gateway to Transparent Philanthropy</h2>
          <p className="text-gray-400 max-w-2xl mx-auto">
            Built on Moonbeam for seamless blockchain giving and complete transparency
          </p>
        </div>
          ...
          {[
            {
              ...
              description: "Send crypto directly to verified charities and projects. Transparent on-chain tracking ensures your donation reaches those in need.",
            ...
            },
            {
              ...
              description: "Transform donations into sustainable yield streams. Your contribution generates ongoing support through conservative DeFi strategies.",
            ...
            },
            {
              ...
              title: "Impact Funds",
              description: "Pool resources for specific causes. Environmental, education, poverty relief - your donation amplified through collective action.",
            ...
            },
            {
              ...
              description: "Every charity undergoes rigorous verification. Legitimate charitable organizations and projects thoroughly vetted for authenticity.",
            ...
            },
            {
              ...
              description: "Soul-bound tokens recognize volunteer contributions. Skills, hours, and impact - all permanently recorded on-chain.",
            ...
            },
            {
              ...
              description: "Seamless connections across multiple blockchains via Moonbeam. Give in DOT, GLMR, or major stablecoins.",
      ...
      <section className="relative z-10 container mx-auto px-6 py-20">
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <div className="text-emerald-400 font-semibold mb-3">For Crypto-Native Donors</div>
            ...
            <div>
              <div className="text-teal-400 font-semibold mb-3">For Non-Profit Organizations</div>
              <ul className="space-y-2 text-gray-300">
                <li className="flex items-start">
                  <Check className="w-5 h-5 text-green-400 mr-2 mt-0.5 flex-shrink-0" />
            ...
            <div>
              <div className="text-cyan-400 font-semibold mb-3">For Volunteers</div>
              <ul className="space-y-2 text-gray-300">
                <li className="flex items-start">
                  <Check className="w-5 h-5 text-green-400 mr-2 mt-0.5 flex-shrink-0" />
      ...
      {/* Impact Showcase */}
      <section id="impact" className="relative z-10 container mx-auto px-6 py-20">
        <h2 className="text-4xl font-bold text-center mb-12">Planned Impact Funds</h2>
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl overflow-hidden hover:border-emerald-500/30 transition-all">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-400 mb-4">
                Supporting reforestation, ocean cleanup, and renewable energy initiatives. Pooled donations
                directed to verified environmental organizations making measurable impact.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl overflow-hidden hover:border-teal-500/30 transition-all">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-400 mb-4">
                Providing scholarships, digital learning tools, and teacher training. Collective funding
                amplified to support educational initiatives in underserved communities.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative z-10 container mx-auto px-6 py-20">
        <div className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-3xl p-12 text-center">
          ...
          <div className="grid md:grid-cols-4 gap-6 text-center">
            <div>
              <div className="text-3xl font-bold text-emerald-400 mb-2">51+</div>
              <div className="text-sm text-gray-400">Polkadot Parachains</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-teal-400 mb-2">Low Fees</div>
      ...
      <section className="relative z-10 container mx-auto px-6 py-20">
        <div className="bg-gradient-to-r from-emerald-600 to-teal-600 rounded-3xl p-12 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Be among the first to experience transparent, blockchain-powered philanthropy.
      ...
      <footer className="relative z-10 container mx-auto px-6 py-12 border-t border-white/10">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              ...
              <li><a href="#impact" className="hover:text-emerald-400">Impact Funds</a></li>
              <li><a href="#charities" className="hover:text-emerald-400">For Charities</a></li>
              <li><a href="#volunteer" className="hover:text-emerald-400">For Volunteers</a></li>
            </ul>
          </div>
          <div>
        ...
        <div className="pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
          <p>© 2025 Give Protocol Foundation. Building on Moonbeam. Powered by Give Protocol volunteers.</p>
        </div>
      </footer>
    </div>
  );
